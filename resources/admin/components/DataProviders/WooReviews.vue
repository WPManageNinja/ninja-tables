<template>
    <div v-loading="loading" class="ninja_modal-body">
        <h3 class="nt-modal-title">
            {{ $t('Construct Table from Your WooCommerce Product Reviews') }}
        </h3>

        <p class="nt-modal-description">
            {{ $t('Displays WooCommerce product reviews in a searchable, sortable, customized table.') }}
...
<!--            </a>-->
        ...
        <div class="nt-modal-footer">
            ...
            <NinjaButton @click="save" :btnText="$t('Create Reviews Table')" />
        </div>
    </div>
</template>
...
<script type="text/babel">
    ...
    import WooReviewNav from "../TableNav/WooReviewNav.vue";
    ...
    export default {
        ...
        methods: {
            save() {
                ...
                this.$post({
                    action: 'ninja_table_woocommerece_create_reviews_table',
