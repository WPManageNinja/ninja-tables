<template>
    <div class="my-[25px]">
        ...
        <div v-else class="bg-[#EBF1FF] p-3 mt-[10px] mb-[25px] rounded-[8px]">
            <div class="text-[#0E121B] font-[500] text-[14px]">{{$t('Create your metadata on your FluentCart platform')}}</div>
            <div class="my-4 text-[#0E121B] font-[400] text-[14px]">{{$t('No product metadata available for this type. Please create them in FluentCart to use here')}}</div>
        </div>
    </div>
</template>
