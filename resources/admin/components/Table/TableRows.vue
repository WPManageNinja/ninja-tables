<template>
    <div class="table-rows">
        <template v-if="!isEditable">
            ...
            <div v-else-if="dataSourceType === 'wp_woo_reviews'" class="nt-table-edit-nav">
                <div>
                    <WooReviewsNavEdit
                        :model="new_column"
                        :config="config"
            ...
            <div v-else-if="dataSourceType === 'wp_fct'" class="nt-table-edit-nav">
                <div>
                    <fc-nav-edit
                        :model="new_column"
                        :config="config"
...
<script type="text/babel">
    ...
    import FcNavEdit from "../TableNav/FcNavEdit.vue";
    ...
    import WooReviewsNavEdit from "../TableNav/WooReviewsNavEdit.vue";
    ...
    export default {
        ...
        methods: {
            ...
            storeSettings() {
                this.bus.emit('updateTableColumns',this.updateHandler);
            },
            duplicateData(item) {
