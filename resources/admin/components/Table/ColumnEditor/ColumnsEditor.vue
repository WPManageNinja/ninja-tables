        ...
        <el-tabs class="nt_tab_design" v-model="activeTab" @tab-click="onTabClick">
            ...
            <el-tab-pane class="basic_settings ninja_modal_body px-[10px] pt-[18px]" label="Basic Settings" name="basic">
                ...
                <WPPostDynamicColumn
                    ...
                    :column="model"
                />
                <template v-else-if="dataSourceType == 'wp_woo' || dataSourceType == 'wp_woo_reviews'">
                    <DynamicWooColumn
                        :columns="columns"
                        :column="model"
                    />
                </template>
                <template v-else-if="dataSourceType === 'wp_fct'">
                    <FluentCartDynamicColumn
                        :columns="columns"
                        :column="model"
                    />
                </template>
            ...
            <el-tab-pane label="Advanced Settings" name="advanced" class="ninja_modal_body px-[10px] pt-[10px]">
                <div class="advanced-settings">
                    ...
                    <div v-if="model.enable_html_content" class="flex flex-col mt-2">
                        ...
                        <wpEditor v-model="model.header_html_content"></wpEditor>
                    </div>
...
<script>
    ...
    import FluentCartDynamicColumn from '../../DataProviders/FluentCartDynamicColumn';
