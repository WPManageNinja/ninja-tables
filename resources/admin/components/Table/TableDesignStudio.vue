        ...
        generateColorCss() {
                ...
                let css = `
                    ...
                    ${prefix}:not(.hide_all_borders) tbody tr td {
                     ...
                     ${prefix}:not(.hide_all_borders) tbody tr:last-child td {
                        border-bottom: ${this.tableSettings.table_color_border !== '' ? `1px solid ${this.tableSettings.table_color_border} !important` : 'none !important'};
                     }
                ...
                if (this.tableSettings.table_color_border === '' && this.tableSettings.table_color_header_border !== '') {
                    css += `
                    ${prefix}:not(.hide_all_borders) tr.footable-header th:first-child,
                    ${prefix}:not(.hide_all_borders) tbody tr th:first-child {
                        border-left: 1px solid ${this.tableSettings.table_color_header_border} !important;
                    }
                    ${prefix}:not(.hide_all_borders) tr.footable-header th:last-child,
                    ${prefix}:not(.hide_all_borders) tbody tr th:last-child {
                        border-right: 1px solid ${this.tableSettings.table_color_header_border} !important;
                    }
                    `;
                }

                // if (this.tableSettings.table_color_border_hover !== '') {
                //     css += `
                //     ${prefix} tbody tr td {
                //         border-top: 1px solid transparent;
                //         border-bottom: 1px solid transparent;
                //     }
                //     ${prefix} tbody tr td:first-child {
                ...
                //     }
                //     ${prefix} tbody tr:hover td {
                //         border-color: ${this.tableSettings.table_color_border_hover};
                //     }
                //     ${prefix} tbody tr:hover td:first-child {
                //         border-left: 1px solid ${this.tableSettings.table_color_border_hover};
                //     }
                //     ${prefix} tbody tr:hover td:last-child {
                //         border-right: 1px solid ${this.tableSettings.table_color_border_hover};
                //     }
                //     `;
                // }
