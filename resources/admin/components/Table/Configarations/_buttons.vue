...
<!--                    </div>-->
                ...
                <div class="form_group">
                    <el-radio-group size="small" v-model="table_buttons.button_position">
                        <el-radio-button v-for="(button_position,position_key) in button_positions" :key="position_key" :label="position_key" :value="position_key" />
                    </el-radio-group>
                </div>
                ...
                <div class="form_group">
                    ...
                    <el-radio-group size="small" v-model="table_buttons.button_alignment">
                        <el-radio-button v-for="(button_align,align_key) in buttonAlignments" :key="align_key" :label="align_key" :value="align_key" />
