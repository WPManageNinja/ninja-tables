    ...
    <el-tabs v-model="activeName" @tab-click="handleClick" class="ninja-tables-component nt_tab_design nt_tab_design_drag mt-[58px]">
        <el-tab-pane :label="$t('Elements')" name="elements" v-if="!manageCell.active">
            <el-collapse accordion v-model="activeNames" @change="handleChange"
                         v-for="(component, index) in initialData.components" :key="component.key" class="accordions nt-table-builder-collapse">
                <el-collapse-item v-if="component.key !== 'container'" :title="component.name" :name="index">
                    <el-row :gutter="20" class="flex flex-col justify-center">
                        <draggable
        ...
        <el-tab-pane :label="$t('Options')" name="options"
            ...
            <el-collapse v-model="activeOption" accordion @change="accorDianChange" class="accordions nt-table-builder-collapse">
                <el-collapse-item :title="$t(ucWords(item.data.type) + ' Options')" name="1">
                    <text-option v-if="item.data.type === 'text'" :item="item" :settings="initialData.settings"/>
                    <button-option v-else-if="item.data.type === 'button'" :item="item" :settings="initialData.settings" />
                    <star-rating v-else-if="item.data.type === 'star_rating'" :item="item"></star-rating>
                    <icon-option v-else-if="item.data.type === 'icon'" :item="item" :settings="initialData.settings" />
                    <progress-option v-else-if="item.data.type === 'progress'" :item="item" :settings="initialData.settings"  />
                    ...
                    <text-icon-option v-else-if="item.data.type === 'text_icon'" :item="item" :settings="initialData.settings" />
        ...
        <el-tab-pane :label="$t('Settings')" name="settings" v-if="!manageCell.active">
            <el-collapse accordion v-model="activeNames" @change="handleChange"
                         ...
                         :key="key" class="accordions nt-table-builder-collapse">
            ...
            <el-collapse v-model="activeNames" class="accordions nt-table-builder-collapse" @change="handleChange">
        ...
        <el-tab-pane :label="$t('Responsiveness')" name="responsiveness" v-if="!manageCell.active">
            <el-collapse accordion v-model="activeNames" @change="handleChangeResponsive"
                         v-for="(responsiveItem, key) in initialData.responsive" :key="key" class="accordions nt-table-builder-collapse">
        ...
        <el-tab-pane :label="$t('Manage cell')" name="cells" class="p-5" v-if="manageCell.activeTab === 'cells'">
            ...
            <NinjaButton @click="closeCellEditing" type="primary" class="ntb-manage-button mt-4"> {{ $t('Close') }}</NinjaButton>
        </el-tab-pane>
