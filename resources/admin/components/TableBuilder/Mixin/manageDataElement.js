export const manageDataElement = {
    computed: {
        ...
        fontSizeValue: {
            get() {
                const itemFontSize = Number(this.item.data.style.fontSize);
                const globalFontSize = Number(this.settings.global_styling.options.font_size.value);
                return (itemFontSize === 10) ? globalFontSize : itemFontSize;
            },
            set(value) {
                this.item.data.style.fontSize = value;
            }
        },
        displayBlock() {
            return {
        ...
        progressBarTextStyle() {
            ...
            return {
                ...
                '--progress-bar-color': progressBarTxtStyle.progressColor === '' ? this.setting.global_styling.options.progressColor.value : progressBarTxtStyle.progressColor,
