    ...
    <div class="nt-table-global-settings-content">
        ...
        <div class="nt-global-settings-content" v-loading="loading">
            ...
            <div class="text-[14px] font-[400] text-[#3C434A] mt-[10px] mb-[20px]">
                {{
                    $t(`If you want to clear all the Ninja tables cache, please click on the "Clear Table Cache" button or if you want to clear the cache by popular external plugins please click "Clear External Caches".`)
                }}
            </div>
