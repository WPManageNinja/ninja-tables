...
export const initFootables = (scriptLoaded, tableElementId, settings, getTableConfig) => {
    ...
    if (isTruthy(settings.hide_on_empty)) {
...
export const getTableConfig = (tableConfig, formattedColumns, settings, wrapperElementId) => {
    ...
    const tableSettings = {
        ...
        filtering: isTruthy(configSettings.enable_search),
        i18n: {},
        use_parent_width: false,
        sorting: isTruthy(configSettings.column_sorting),
    ...
    const initConfig = {
        ...
        empty: '',
        filtering: {
            enabled: isTruthy(configSettings.enable_search)
        },
        paging: {
        ...
        sorting: {
            enabled: isTruthy(configSettings.column_sorting)
        },
    };
